"""Apply culture_db/tshdeoa04.sql using AURORA_DB_URL."""
...
def main() -> None:
    ...
    from culture_db.tshdeoa04_setup import ensure_tshdeoa04_table, sync_tshdeoa04_column_comments

    with psycopg2.connect(db_url()) as conn:
        ensure_tshdeoa04_table(conn)
        n = sync_tshdeoa04_column_comments(conn)
        conn.commit()
    ...
    print(f"OK: applied tshdeoa04.sql (table={fq}, column comments={n})")
