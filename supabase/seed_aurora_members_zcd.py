...
def main() -> None:
    ...
    from supabase.aurora_setup import ensure_tshde0zcd_table
    from supabase.culture_db import get_culture_db_url
    from supabase.members_setup import setup_members
    from supabase.table_config import MEMBER_TABLE_NAME, TSHDE0ZCD_SCHEMA, TSHDE0ZCD_TABLE
